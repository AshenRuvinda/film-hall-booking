// frontend/src/pages/user/UserRegister.js - MOVIE BOOKING ENHANCED VERSION
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-sm">Create your account to start booking movies</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start text-sm">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 text-red-500 bg-white/10 border-white/20 rounded focus:ring-red-500 focus:ring-2 mt-1"
                required
              />
